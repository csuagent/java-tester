 ...
 */
public class Decoder_Old
{
  /** factory that creates the <code>DocumentBuilder</code> objects used for decoding */
  ...
  /**
   * Parses a string containing an XML document into a <code>Document</code> object.
   * 
   * @param document the string containing an XML document
  ...
  /**
   * Returns all the child element nodes from the given node.
   * All other child nodes from teh given node are ignored.
   * 
   * @param node the nodes whose child elements are needed
  ...
  /**
   * Returns an element from the given list of elements if it exists at the given index and has the given name.
   * 
   * @param elements the list of elements 
   * @param index the index of the desired element
   * @param name the name of the desired element
   * @return the desired element
   * @throws IllegalArgumentException if there is no element at the desired index of if such an element has a different name
   */
   ...
   * 
   * @param element the element whose text content is needed
   * @return the text content of the given element
   * @throws IllegalArgumentException if the element has multiple children.
   * @throws ClassCastException if the single child of the element is not a <code>Text</code> node.
   */
  protected String getText(Element element)
  {
    ...
    {
      case 0: return "";
      case 1: return ((Text)nodes.item(0)).getNodeValue();
      default: throw new IllegalArgumentException("element " + element.getNodeName() + " contains more than just text");
    }
  }
  ...
  /**
   * Wrapper around <code>Class.forName(String)</code> that can also handle primitive types.
   * 
  ...
  /**
   * Decodes a type/value pair from the given DOM representation of the request parameter.
   * 
   * @param parameter the DOM representation of the request parameter
   * @return a string array with two components: the first is the type and the second is the value of the parameter
   */
