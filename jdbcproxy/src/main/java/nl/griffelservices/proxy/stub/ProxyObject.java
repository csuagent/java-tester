...
public class ProxyObject implements Cloneable
{
   ...
   * 
   * @param proxyClass the interface for which this is the proxy data
   * @param proxyId the id of the object for which this is the proxy data
   * @param proxyStatus the status of the object for which this is the proxy data
   * @param requestResponse the pre-configured stub responses for a set of requests
   */
   ...
   * 
   * @param proxyStatus the new status of the object for which this is the proxy data
   */
   ...
   * @param i the index of the desired pre-configured request/response pair
