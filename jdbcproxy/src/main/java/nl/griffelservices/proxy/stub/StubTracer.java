...
/**
 * The stub-tracer takes care of the actual logging of the trace information for the {@link StubTracerHandler}.
 * 
 * @author Frans van Gool
 */
public interface StubTracer
{
  /**
   * Logs the trace of a single method call.
   * 
   * @param request the request information of the method call
   * @param response the response information of the method call
