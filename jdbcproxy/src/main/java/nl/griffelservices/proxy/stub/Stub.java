...
/**
 * The stub gets the actual stub responses for the {@link StubHandler}.
 * 
...
{
  /**
   * Returns the stub response for the given request.
   * 
   * @param request the request for which a response is needed
   * @return the stub response for the request
